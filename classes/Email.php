...
class Email {
    ...
    public function enviarConfirmacion(){
         ...
         $mail->setFrom('cuentas@Concesionario.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en ConcesionarioCOL; pero es necesario confirmarla</p>";
